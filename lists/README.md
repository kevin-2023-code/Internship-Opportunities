...
_Between them these 23 filters hold **652 of the 711** internships on this list (92%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._

| Filter | The United States & Canada | Elsewhere | What it selects |
| :-- | --: | --: | :-- |
| [🏛️ Big Tech](company/big-tech.md) | 364 | 2 | A derived cut, not a hand-picked list: the employer is in one of the technology sectors and the registry records its headcount as 10,000 people or more. An employer the registry does not cover is in no size cut at all. |
...
_Between them these 2 filters hold **134 of the 711** internships on this list (19%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._

| Filter | The United States & Canada | Elsewhere | What it selects |
| :-- | --: | --: | :-- |
| [🆕 Posted in the last 7 days](new-this-week.md) | 116 | 8 | Published or re-posted within 7 days of the last run. A posting with no date is not here: undated is not recent. |
