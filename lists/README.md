...
| [🔧 Hardware & Engineering](field/hardware-and-engineering.md) | 257 | 8 |
| [🤖 Data, AI & Machine Learning](field/data-ai-and-machine-learning.md) | 81 | 3 |
| [📱 Product & Design](field/product-and-design.md) | 45 | 7 |
...
_Between them these 23 filters hold **654 of the 713** internships on this list (92%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._
...
_Between them these 12 filters hold **293 of the 713** internships on this list (41%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._
...
| Filter | The United States & Canada | Elsewhere |
| :-- | --: | --: |
| [Software Engineer](role/software-engineer.md) | 75 | 13 |
...
_Between them these 20 filters hold **518 of the 713** internships on this list (73%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._
...
_Between them these 2 filters hold **135 of the 713** internships on this list (19%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._

| Filter | The United States & Canada | Elsewhere | What it selects |
| :-- | --: | --: | :-- |
| [🆕 Posted in the last 7 days](new-this-week.md) | 118 | 7 | Published or re-posted within 7 days of the last run. A posting with no date is not here: undated is not recent. |
